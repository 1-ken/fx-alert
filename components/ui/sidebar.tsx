...
function SidebarTrigger({
  ...
  return (
    <Button
      ...
      size="icon"
      className={cn(
        "text-sidebar-foreground ring-sidebar-ring hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground size-7",
        className
      )}
      onClick={(event) => {
        onClick?.(event)
...
function SidebarMenuSkeleton({
  ...
  // Using useState with lazy initializer ensures Math.random() only runs once
